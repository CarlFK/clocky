...
from styles import *
from helpers import Dyer, Face, Hand, SweepHand, HandSet, TickSet, Box
...
class AnalogClock(wx.PyWindow):
    ...
    def __init__(self, parent, id=wx.ID_ANY, pos=wx.DefaultPosition,
        ...
        self.timer_interval = timer_interval # milliseconds
        ...
        handS = Hand(size=3, lenfac=0.95)
        handW = SweepHand(size=1, lenfac=1.4, sweep_frequency=sweep_frequency)
        self.Hands = HandSet(self, handH, handM, handS, handW)
    ...
    def _OnShowAbout(self, evt):
        msg = "AnalogClock\n\n" \
              ...
              "and sweep hand hacks by David Goodger."
        title = "About..."
